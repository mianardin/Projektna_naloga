...
def get_dict_from_drzava_block(block):
    ...
    return {"ime": ime, "kontinent": kontinent, "območje (km2)": obmocje, "populacija": populacija,
             "gdp (USD per capita)": gdp, "življenska doba (leta)": ziv_doba, "vlada": vlada,
               "gostota (ljudi na km2)": gostota, "vera": vera}
